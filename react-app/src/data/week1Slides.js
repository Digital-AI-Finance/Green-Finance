export const week1Slides = [
  // LEARNING GOAL 1: Market Microstructure Theory (Slides 1-13)
  ...
  // NEW Slide 2: Information Flow Network Chart
  {
    id: 2,
    type: 'interactive_chart',
    title: 'Information Flows in Green Finance Markets',
    chartType: 'information_flow_network',
    bottomNote: '[Goal 1] Interactive network showing relationships between market participants',
    goalReference: 1
  },

  // Slide 3 (Slide 3): Why Green Finance Markets Exist
  {
    id: 3,
    type: 'two_column',
  ...
  // NEW Slide 4: Green Finance Timeline Chart
  {
    id: 4,
    type: 'interactive_chart',
    title: 'Evolution of Green Finance: Key Milestones 2007-2024',
    chartType: 'green_finance_timeline',
    bottomNote: '[Goal 1] Click milestones to explore market development history',
    goalReference: 1
  },

  // Slide 5 (Slide 4): Information Asymmetry Problem
  {
    id: 5,
    type: 'two_column',
  ...
  // NEW Slide 6: Regulatory Hierarchy Chart
  {
    id: 6,
    type: 'interactive_chart',
    title: 'Global Regulatory Framework Hierarchy',
    chartType: 'regulatory_hierarchy',
    bottomNote: '[Goal 1] Interactive tree showing international, regional, and national standards',
    goalReference: 1
  },

  // Slide 7 (Slide 5): Market Segmentation
  {
    id: 7,
    type: 'two_column',
  ...
  // Slide 8 (Slide 6): Greenium Theory
  {
    id: 8,
    type: 'two_column',
  ...
  // Slide 9 (Slide 7): Verification and Standards
  {
    id: 9,
    type: 'two_column',
  ...
  // Slide 10 (Slide 8): Liquidity Considerations
  {
    id: 10,
    type: 'two_column',
  ...
  // Slide 11 (Slide 9): Reputation and Repeat Issuance
  {
    id: 11,
    type: 'two_column',
  ...
  // Slide 12 (Slide 10): Goal 1 Summary
  {
    id: 12,
    type: 'goal_summary',
    goalNumber: 1,
  ...
  // LEARNING GOAL 2: Quantify Market Size & Growth (Slides 14-23)

  // Slide 13 (Slide 11): Learning Goal 2 Title
  {
    id: 13,
    type: 'learning_goal_title',
    goalNumber: 2,
  ...
  // NEW Slide 14: World Map Choropleth
  {
    id: 14,
    type: 'interactive_chart',
    title: 'Global Green Finance Market Distribution by Country',
    chartType: 'world_map_choropleth',
    bottomNote: '[Goal 2] Click countries to see market details; toggle per-capita view',
    goalReference: 2
  },

  // Slide 15 (Slide 12): Market Size Overview
  {
    id: 15,
    type: 'two_column',
  ...
  // Slide 16 (Slide 13): Interactive Market Growth Chart
  {
    id: 16,
    type: 'interactive_chart',
  ...
  // NEW Slide 17: Issuance Stacked Area Chart
  {
    id: 17,
    type: 'interactive_chart',
    title: 'Green Finance Instrument Growth by Type (2015-2024)',
    chartType: 'issuance_stacked_area',
    bottomNote: '[Goal 2] Click legend to show/hide instrument types',
    goalReference: 2
  },

  // Slide 18 (Slide 14): Growth Drivers
  {
    id: 18,
    type: 'two_column',
  ...
  // NEW Slide 19: Top Issuers Bar Chart
  {
    id: 19,
    type: 'interactive_chart',
    title: 'Top 15 Green Finance Issuers by Total Issuance',
    chartType: 'top_issuers_bar',
    bottomNote: '[Goal 2] Click bars for detailed issuer information and breakdown',
    goalReference: 2
  },

  // Slide 20 (Slide 15): Issuer Composition
  {
    id: 20,
    type: 'two_column',
  ...
  // Slide 21 (Slide 16): Greenium Empirical Evidence
  {
    id: 21,
    type: 'two_column',
  ...
  // Slide 22 (Slide 17): Risk-Return Profile
  {
    id: 22,
    type: 'interactive_chart',
  ...
  // NEW Slide 23: Market Forecast Chart
  {
    id: 23,
    type: 'interactive_chart',
    title: 'Green Finance Market Projections: 2024-2030',
    chartType: 'market_forecast',
    bottomNote: '[Goal 2] Toggle scenarios to compare forecasts; includes confidence intervals',
    goalReference: 2
  },

  // Slide 24 (Slide 18): Verification Market
  {
    id: 24,
    type: 'two_column',
  ...
  // Slide 25 (Slide 20): Goal 2 Summary
  {
    id: 25,
    type: 'goal_summary',
    goalNumber: 2,
  ...
  // LEARNING GOAL 3: Derive Pricing Models (Slides 26-36)

  // Slide 26 (Slide 21): Learning Goal 3 Title
  {
    id: 26,
    type: 'learning_goal_title',
    goalNumber: 3,
  ...
  // Slide 27 (Slide 22): Classical Bond Pricing Foundation
  {
    id: 27,
  ...
  // Slide 28 (Slide 23): Green Bond Pricing with Greenium
  {
    id: 28,
    type: 'math_derivation',
  ...
  // NEW Slide 29: Yield Curve Surface Chart
  {
    id: 29,
    type: 'interactive_chart',
    title: 'Green Bond Yield Surface: Maturity vs. Greenium',
    chartType: 'yield_curve_surface',
    bottomNote: '[Goal 3] Hover over surface to see yield at different maturity/greenium combinations',
    goalReference: 3
  },

  // Slide 30 (Slide 24): Multi-Factor Green Pricing Model
  {
    id: 30,
    type: 'math_derivation',
  ...
  // NEW Slide 31: Price Sensitivity Calculator
  {
    id: 31,
    type: 'interactive_chart',
    title: 'Interactive Green Bond Price Sensitivity Calculator',
    chartType: 'price_sensitivity_calculator',
    bottomNote: '[Goal 3] Adjust parameters to see real-time impact on bond pricing and metrics',
    goalReference: 3
  },

  // Slide 32 (Slide 25): Duration and Convexity
  {
    id: 32,
    type: 'math_derivation',
  ...
  // Slide 33 (Slide 26): Stochastic Greenium Model
  {
    id: 33,
    type: 'math_derivation',
  ...
  // NEW Slide 34: Efficient Frontier Chart
  {
    id: 34,
    type: 'interactive_chart',
    title: 'Efficient Frontier with Green Asset Allocation',
    chartType: 'efficient_frontier',
    bottomNote: '[Goal 3] Adjust green allocation slider to see portfolio metrics; click points for details',
    goalReference: 3
  },

  // Slide 35 (Slide 27): ESG Score Integration
  {
    id: 35,
    type: 'two_column',
  ...
  // Slide 36 (Slide 28): Credit Risk and Green Bonds
  {
    id: 36,
    type: 'two_column',
  ...
  // Slide 37 (Slide 29): Portfolio Optimization with Green Assets
  {
    id: 37,
    type: 'math_derivation',
  ...
  // Slide 38 (Slide 30): Goal 3 Summary
  {
    id: 38,
    type: 'goal_summary',
    goalNumber: 3,
